...
<div align="center">
    ...
    <form method="POST" name="/add" action="<%=request.getContextPath()%>/add">
        <div class="table_wrap">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><c:if test="${not empty msgErrorName}">${msgErrorName}</c:if></td>
                </tr>
                <tr>
                    <td class="h5">Email :</td>
                    <td><input name="email" value="${employee.email}" type="text"/></td>
                    <td><c:if test="${not empty msgErrorEmail}">${msgErrorEmail}</c:if></td>
                </tr>
                <tr>
                    <td class="h5">Age :</td>
                    <td><input name="age" value="${employee.age}" type="text"/></td>
                    <td><c:if test="${not empty msgErrorAge}">${msgErrorAge}</c:if></td>
                </tr>
